...
SECRET_KEY = 's$((m(t_#pr1^zzw^q!i9!tn(t!yhy28hewft@b+mq#6iketysjfsknfcf@d'
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # Ensures static files work well on production
